    ...
    return (
        <div>
            <div className='text-center space-y-4 mt-40'>
                ...
                <p className='text-[0.80rem] md:text[14px] lg:text-[16px] text-[#64748B]'>Your personal shelf of meaningful connections. Browse, tend, and nurture the <br />
                    relationships that matter most.</p>
                <button className='btn bg-[#244D3F] text-white w-36 h-11'><FaPlus /> Add a Friend</button>
            </div>

            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center gap-2 md:gap-5 lg:gap-6 my-10'>
